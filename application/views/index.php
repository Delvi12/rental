...
<div id="infodlg" style="display:none"></div> 
    <header class="dark_grey"> <!-- Header start -->
        ...
        <ul class="header_actions">
            ...
            <li class="dropdown"><a href="#">Selamat Datang<i class="icon-angle-down"></i></a>
            </li>
    ...
    <div id="main_navigation" class="dark_grey"> <!-- Main navigation start -->
        <div class="inner_navigation">
            <ul class="main">
                <li><a href="#"><i class="icon-tasks"></i><b>RENTAL KAMERA</b></a></li>
                <li><a href="<?php echo base_url() ?>daftar"><i class="icon-tasks"></i>Daftar</a></li>
                <li><a href="<?php echo base_url() ?>beli"><i class="icon-tasks"></i>Menu</a></li>
                <li><a href="<?php echo base_url() ?>barang/listbarang"><i class="icon-tasks"></i>Pembayaran</a></li>
